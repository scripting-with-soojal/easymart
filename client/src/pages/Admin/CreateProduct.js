                    ...
                    <div className="col-md-9">
                        ...
                        <div className="m-1 w-75">
                            ...
                            <div className="m-3 row">
                                {/* <p> */}
                                <label className="btn btn-outline-secondary col-md-12 position-static">
                            ...
                            <Modal
                                ...
                                open={visible}
                            >
                                <button className="btn btn-danger" onClick={() => { setPhoto(""); setVisible(false) }}>Remove Photo</button>
                            </Modal>
                        </div>
                    </div>
                </div>
